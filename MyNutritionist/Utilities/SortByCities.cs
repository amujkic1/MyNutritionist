...
{
    // Implementacija ISort interfejsa za sortiranje objekata PremiumUser po gradovima
    public class SortByCities : ISort
    {
        ...
        public List<PremiumUser> QuickSort(List<PremiumUser> users)
        {
            ...
            for (int i = 0; i < users.Count; i++)
            {
                ...
                // Uporedi elemente sa pivotom bazirano na City svojstvu
                int comparisonResult = string.Compare(users[i].City, pivotUser.City, StringComparison.OrdinalIgnoreCase);
