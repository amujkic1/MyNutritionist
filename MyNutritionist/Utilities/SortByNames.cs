    ...
    public class SortByNames : ISort
    {
        ...
        public List<PremiumUser> QuickSort(List<PremiumUser> users)
        {
            ...
            for (int i = 0; i < users.Count; i++)
            {
                ...
                // Uporedi elemente sa pivotom bazirano na FullName svojstvu
                int comparisonResult = string.Compare(users[i].FullName, pivotUser.FullName, StringComparison.OrdinalIgnoreCase);
