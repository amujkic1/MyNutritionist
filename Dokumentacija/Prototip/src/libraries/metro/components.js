...
prx.types.metro_dropdown_withselection = {
    ...
    , afterDisplay: function (item, containerid, symbol) {
        var _id = (!containerid) ? item.id : containerid + '-' + item.id;
        if (!prx.editor) {
            let selector = ' .metro-dropdown-contextmenu';
            ...
            $('#' + _id + ' .dropdown-trigger').hammer({domEvents: false}).on('tap', function (e) {
                ...
                if (!$('#' + _id + selector).is(':visible')) {
                    ...
                    if (prx.currentPlayerStatus.helper.get(_id, "buttons")[prx.currentPlayerStatus.helper.get(_id, "selected")]) {
                        selectedText = prx.currentPlayerStatus.helper.get(_id, "buttons")[prx.currentPlayerStatus.helper.get(_id, "selected")].text;
                    }
